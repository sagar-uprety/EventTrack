...
function AttributesGetter(Implementation, params, opts, collectionName) {
  ...
  this.perform = function () {
    ...
    return Implementation.Intercom.getCustomer(model, params.recordId).then(function (customer) {
      ...
      user.geoloc = [user.location_data.latitude, user.location_data.longitude];
      ...
      return P.map(user.segments.segments, function (segment) {
        return intercom.segments.find({
          id: segment.id
        }).then(function (response) {
