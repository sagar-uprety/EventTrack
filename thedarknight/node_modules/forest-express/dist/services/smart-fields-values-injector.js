...
function SmartFieldsValuesInjector(record, modelName, fieldsPerModel) {
  ...
  function setSmartFieldValue(record, field, modelName) {
    ...
    if (!_.isNil(value)) {
      ...
      return value.then(function _callee(smartFieldValue) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                smartFieldsValuesInjector = new SmartFieldsValuesInjector(smartFieldValue, getReferencedModelName(field), fieldsPerModel, depth + 1);
                _context.next = 4;
                return _regenerator["default"].awrap(smartFieldsValuesInjector.perform());
      ...
      if (!record[field.field]) {
        ...
        if (schemaAssociation && !_.isArray(field.type)) {
          return P.each(schemaAssociation.fields, function (fieldAssociation) {
            ...
            if (!record[field.field][fieldAssociation.field] && (fieldAssociation.get || fieldAssociation.value)) {
